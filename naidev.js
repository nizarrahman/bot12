...
didin.sendListMsg(m.chat, `*_Hai kak ${pushname} ${ucapanWaktu}_*\n\n_Aku 𝗕𝗼𝘁 𝗢𝗳𝗳𝗶𝗰𝗶𝗮𝗹 𝗡𝗮𝗶 𝗦𝘁𝗼𝗿𝗲 Bot whatsapp multi-device yang Di Ciptakan Oleh 4 pemuda Tukang halu NT mulu dan Wibu yaitu Nizar, Adryan,Irham. Bot Ini Di Ciptakan untuk membantumu_*`, '', '', `Click Here!`, sections, m)
}
break
case 'gamemenu':{
  // send a list message!
